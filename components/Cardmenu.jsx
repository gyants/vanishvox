const Cardmenu = ({data, timeRemaining, type}) => {
  return (
    <div 
    className={type == 'card' ? `card-menu w-full flex justify-between font-medium text-xs` : `card-menu w-full flex gap-5 font-medium text-xs`}>
